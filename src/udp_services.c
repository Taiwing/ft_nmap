...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/22 10:07:56 by yforeau           #+#    #+#             */
/*   Updated: 2021/09/22 10:07:57 by yforeau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_nmap.h"

const char	*g_udp_services[USHRT_MAX + 1][2] = {
	...
	[63]	= { "via-ftp", "VIA Systems - FTP & whois++" },
	...
	[77]	= { "priv-rje", "any private RJE service, netjrs" },
	[78]	= { "vettcp", NULL },
	[79]	= { "finger", NULL },
	...
	[102]	= { "iso-tsap", "tsap ISO-TSAP Class 0" },
	...
	[190]	= { "cacp", "Gateway Access Control Protocol" },
	...
	[247]	= { "subntbcst_tftp", NULL },
	[248]	= { "bhfhs", NULL },
	[256]	= { "rap", NULL },
	[257]	= { "set", "secure electronic transaction" },
	[258]	= { "yak-chat", "yak winsock personal chat" },
	[259]	= { "firewall1-rdp", "Firewall 1 proprietary RDP protocol http://www.inside-security.de/fw1_rdp_poc.html" },
	[260]	= { "openport", NULL },
	[261]	= { "nsiiops", "iiop name service over tls/ssl" },
	[262]	= { "arcisdms", NULL },
	[263]	= { "hdap", NULL },
	[264]	= { "fw1-or-bgmp", "FW1 secureremote alternate" },
	...
	[312]	= { "vslmp", NULL },
	[313]	= { "magenta-logic", NULL },
	[314]	= { "opalis-robot", NULL },
	[315]	= { "dpsi", NULL },
	[316]	= { "decauth", NULL },
	[317]	= { "zannet", NULL },
	...
	[363]	= { "rsvp_tunnel", NULL },
	[364]	= { "aurora-cmgr", NULL },
	...
	[374]	= { "legent-2", "Legent Corporation (now Computer Associates Intl.)" },
	[375]	= { "hassle", NULL },
	...
	[459]	= { "ampr-rcmd", NULL },
	[460]	= { "skronk", NULL },
	[461]	= { "datasurfsrv", NULL },
	[462]	= { "datasurfsrvsec", NULL },
	[463]	= { "alpes", NULL },
	...
	[544]	= { "kshell", "krcmd Kerberos (v4/v5)" },
	[545]	= { "appleqtcsrvr", NULL },
	[546]	= { "dhcpv6-client", "DHCPv6 Client" },
	[547]	= { "dhcpv6-server", "DHCPv6 Server" },
	[548]	= { "afp", "AFP over UDP" },
	[549]	= { "idfp", NULL },
	[550]	= { "new-rwho", "new-who" },
	[551]	= { "cybercash", NULL },
	[552]	= { "deviceshare", NULL },
	[553]	= { "pirp", NULL },
	[554]	= { "rtsp", "Real Time Stream Control Protocol" },
	[555]	= { "dsf", NULL },
	[556]	= { "remotefs", "rfs, rfs_server, Brunhoff remote filesystem" },
	...
	[749]	= { "kerberos-adm", "Kerberos 5 admin/changepw" },
	[750]	= { "kerberos", "kdc Kerberos (v4)" },
	...
	[772]	= { "cycleserv2", NULL },
	[773]	= { "notify", NULL },
	[774]	= { "acmaint_dbd", NULL },
	[775]	= { "acmaint_transd", NULL },
	[776]	= { "wpages", NULL },
	...
	[1426]	= { "sas-1", "Satellite-data Acquisition System 1" },
	...
	[1435]	= { "ibm-cics", NULL },
	[1436]	= { "sas-2", "Satellite-data Acquisition System 2" },
	[1437]	= { "tabula", NULL },
	...
	[2006]	= { "raid-cc", "raid" },
	[2007]	= { "raid-am", NULL },
	[2008]	= { "terminaldb", NULL },
	[2009]	= { "whosockami", NULL },
	[2010]	= { "pipe_server", "Also used by NFR" },
	[2011]	= { "servserv", NULL },
	[2012]	= { "raid-ac", NULL },
	[2013]	= { "raid-cd", NULL },
	[2014]	= { "raid-sf", NULL },
	...
	[2017]	= { "bootclient", NULL },
	[2018]	= { "rellpack", NULL },
	[2019]	= { "about", NULL },
	[2020]	= { "xinupageserver", NULL },
	[2021]	= { "xinuexpansion1", NULL },
	[2022]	= { "xinuexpansion2", NULL },
	...
	[2082]	= { "infowave", "Infowave Mobiltiy Server" },
	...
	[2948]	= { "wap-push", "Windows Mobile devices often have this" },
	...
	[3027]	= { "LiebDevMgmt_C", NULL },
	[3028]	= { "LiebDevMgmt_DM", NULL },
	[3029]	= { "LiebDevMgmt_A", NULL },
	...
	[3246]	= { "kademlia", "Kademlia P2P (mlnet)" },
	...
	[3531]	= { "peerenabler", "P2PNetworking/PeerEnabler protocol" },
	...
	[3863]	= { "asap-tcp", "RSerPool ASAP (UDP)" },
	...
	[3938]	= { "dbcontrol_agent", "Oracel dbControl Agent po" },
	...
	[3996]	= { "remoteanything", "neoworx remote-anything slave daemon" },
	[3997]	= { "remoteanything", "neoworx remote-anything master daemon" },
	[3998]	= { "remoteanything", "neoworx remote-anything reserved" },
	[3999]	= { "nvcnet", "Norman distributes scanning service" },
	[4000]	= { "icq", "AOL ICQ instant messaging clent-server communication" },
	[4001]	= { "newoak", "NewOak" },
	[4002]	= { "pxc-spvr-ft", NULL },
	...
	[4073]	= { "iRAPP", "iRAPP Server Protocol" },
	...
	[4151]	= { "menandmice_noh", "Men & Mice Remote Control" },
	[4152]	= { "idig_mux", "iDigTech Multiplex" },
	...
	[4183]	= { "gmmp", "General Metaverse Messaging Protocol" },
	[4184]	= { "universe_suite", "UNIVERSE SUITE MESSAGE SERVICE" },
	...
	[4307]	= { "visicron-vs", "Visicron Videoconference Service" },
	...
	[4342]	= { "lisp-control", "LISP Data-Triggered Control" },
	[4343]	= { "unicall", NULL },
	...
	[4370]	= { "elpro_tunnel", "ELPRO V2 Protocol Tunnel" },
	...
	[4555]	= { "rsip", "RSIP Port" },
	[4556]	= { "dtn-bundle-udp", "DTN Bundle UDP CL Protocol" },
	...
	[4740]	= { "ipfixs", "IP Flow Info Export over DTLS" },
	...
	[4840]	= { "opcua-udp", "OPC UA TCP Protocol" },
	...
	[4846]	= { "contamac_icm", "Contamac ICM Service" },
	...
	[4900]	= { "hfcs", "HyperFileSQL Client/Server Database Engine" },
	...
	[4999]	= { "hfcs-manager", "HyperFileSQL Client/Server Database Engine Manager" },
	...
	[5004]	= { "avt-profile-1", "RTP media data [RFC 3551]" },
	[5005]	= { "avt-profile-2", "RTP control protocol [RFC 3551]" },
	...
	[5010]	= { "telelpathstart", NULL },
	[5011]	= { "telelpathattack", NULL },
	...
	[5145]	= { "rmonitor_secure", NULL },
	[5150]	= { "atmp", "Ascend Tunnel Management Protocol" },
	[5151]	= { "esri_sde", "ESRI SDE Remote Start" },
	...
	[5316]	= { "hpdevms", "HP Device Monitor Service" },
	[5343]	= { "kfserver", "Sculptor Database Server" },
	[5344]	= { "xkotodrcp", "xkoto DRCP" },
	[5349]	= { "stuns", "Reserved for a future enhancement of STUN" },
	[5350]	= { "nat-pmp-status", "NAT-PMP Status Announcements" },
	[5351]	= { "nat-pmp", NULL },
	...
	[5684]	= { "coaps", "DTLS-secured Constrained Application Protocol" },
	...
	[6672]	= { "vision_server", NULL },
	[6673]	= { "vision_elmd", NULL },
	[6689]	= { "tsa", "Tofino Security Appliance" },
	[6697]	= { "babel", "Babel Routing Protocol" },
	...
	[8192]	= { "sophos", "Sophos Remote Management System" },
	[8193]	= { "sophos", "Sophos Remote Management System" },
	[8194]	= { "sophos", "Sophos Remote Management System" },
	...
	[9212]	= { "serverviewdbms", "Server View dbms access [January 2005]" },
	[9213]	= { "serverstart", "ServerStart RemoteControl [August 2005]" },
	...
	[9595]	= { "pds", "Ping Discovery System" },
	...
	[10003]	= { "documentum_s", "EMC-Documentum Content Server Product" },
	...
	[14001]	= { "sua", "De-Registered (2001 June 06)" },
	...
	[26489]	= { "exonet", "EXOnet" },
	[26900]	= { "hexen2", "Hexen 2 game server" },
	...
	[27910]	= { "quake2", "Quake 2 game server" },
	[27960]	= { "quake3", "Quake 3 Arena Server" },
	...
	[32786]	= { "sometimes-rpc26", "Sometimes an RPC port" },
	[32787]	= { "sometimes-rpc28", "Sometimes an RPC port" },
	...
	[44818]	= { "EtherNetIP-2", "EtherNet/IP messaging" },
	...
	[48619]	= { "iqobject", NULL },
	[48899]	= { "tc_ads_discovery", NULL },
	[54321]	= { "bo2k", "Back Orifice 2K Default Port" },
	[64738]	= { "murmur", "Murmur is the server-side software for Mumble open source voice chat software" },
};
